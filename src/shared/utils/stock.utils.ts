...
export const MOVEMENT_TYPE_OPTIONS: MovementTypeOption[] = [
  {
    ...
    icon: ShoppingCart,
    badgeClassName: 'bg-fresco-suave text-fresco-texto',
    hoverClassName: 'hover:bg-fresco-suave focus:bg-fresco-suave',
  },
  {
    value: 'SALE',
    description: 'Venta',
  ...
  },
  {
    ...
    icon: Trash2,
    badgeClassName: 'bg-apoyo-suave text-apoyo-texto',
    hoverClassName: 'hover:bg-apoyo-suave focus:bg-apoyo-suave',
  },
  {
    value: 'ADJUSTMENT',
    description: 'Ajuste',
  ...
  },
  {
    ...
    hoverClassName: 'hover:bg-secondary dark:hover:bg-card focus:bg-secondary dark:focus:bg-card',
  },
];
