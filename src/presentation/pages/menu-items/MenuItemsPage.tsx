  ...
  return (
    <MainLayout>
      <div className="flex flex-wrap justify-between items-center gap-4 px-4 py-2">
        <h1 className="text-3xl lg:text-4xl font-black text-foreground leading-tight tracking-tight">Productos</h1>
      ...
      <ConfirmDialog
        ...
        description={deleteDialog.data && (<>Estás a punto de eliminar el producto <strong className="text-foreground">{deleteDialog.data.name}</strong>.<br /><br />Esta acción no se puede deshacer.</>)}
