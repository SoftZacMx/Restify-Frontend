...
import { Eye, EyeOff, UtensilsCrossed, ArrowLeft, CheckCircle2, XCircle, Check } from 'lucide-react';
...
/**
 * Flujo forgot-password (paso 2): el usuario llega desde el enlace del correo
 * (`/auth/reset-password?token=...`), elige una nueva contraseña y la confirma.
 * Ruta pública (sin login). El token viaja en el body al backend.
 */
