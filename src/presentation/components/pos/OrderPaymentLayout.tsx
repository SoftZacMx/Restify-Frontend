...
export const OrderPaymentLayout: React.FC<OrderPaymentLayoutProps> = ({
  ...
  return (
    <div className="rounded-xl border border-border bg-card overflow-hidden shadow-lg">
      ...
      <div className="flex items-center gap-4 px-6 py-4 border-b border-border bg-muted/50 dark:bg-card/50 shrink-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
        ...
        <div className="border-b lg:border-b-0 lg:border-r border-border p-6 flex flex-col min-h-0">
          ...
          <div className="flex-1 min-h-0 overflow-y-auto space-y-4" data-testid="order-items">
            {cartItems.map((item) => (
              ...
              >
                ...
                <p className="text-sm font-semibold text-foreground shrink-0" data-testid="order-item-total">
          ...
          <div className="mt-4 pt-4 border-t border-border space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium text-foreground" data-testid="order-subtotal">
