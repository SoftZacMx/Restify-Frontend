  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[min(28rem,95vw)] max-h-[90vh] flex flex-col bg-card border border-border p-0 overflow-hidden">
          ...
          <button
            ...
            className={cn(
              ...
              selectedCategoryId === null
                ...
                : 'border-border bg-muted hover:border-border dark:hover:border-border text-foreground'
            )}
          >
        ...
        <footer className="shrink-0 px-6 py-4 border-t border-border flex justify-end">
