    ...
    <div className="flex flex-col h-full">
            ...
            <button
              ...
              className={cn(
                ...
                isSelected
                  ...
                  : 'border-border bg-muted text-foreground hover:border-border dark:hover:border-border'
              )}
            >
              {method.icon}
      ...
      {selectedMethod1 && selectedMethod1 !== 'QR_MP' && (
        <div className="space-y-2 mb-4">
          <Label htmlFor="amount1" className="text-muted-foreground">
            Monto recibido
          </Label>
      ...
      <div className="flex items-center justify-between gap-3 py-3 border-t border-border">
        <div>
          <p className="text-sm font-medium text-foreground">Dividir pago</p>
      ...
      {showSecondPaymentMethod && (
        <div className="space-y-2 mb-4">
          <Label className="text-muted-foreground">Segundo método de pago</Label>
      ...
      {remainingToPay > 0.01 && (
        <div className="flex justify-between text-sm text-apoyo mb-4">
          <span>Resta por pagar</span>
          <span className="font-semibold">${remainingToPay.toFixed(2)}</span>
        </div>
      )}
      {selectedMethod1 && totalEntered > 0 && (
        <div className="flex justify-between text-sm font-semibold py-2 border-t border-border mb-4">
