    ...
    <div className="lg:col-span-3 flex flex-col min-h-0 h-full">
      <Card className="flex flex-col flex-1 min-h-0 overflow-hidden">
        ...
        <CardContent className="flex flex-col flex-1 min-h-0 gap-4 p-4 pt-0 overflow-hidden">
          <div className="relative shrink-0 sticky top-0 z-10  bg-white dark:bg-slate-800  pb-1">
            ...
            <Input
              ...
              className="pl-9 mt-2 shadow-none border-slate-200 dark:border-slate-600"
