  ...
  return (
    <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-6">
      ...
      <div className="rounded-lg bg-muted p-4 space-y-2">
        <p className="text-sm font-medium text-foreground">Estado actual de la ubicación:</p>
        <div className="flex items-center gap-2">
          <span className={cn('inline-block w-3 h-3 rounded-full', !status ? 'bg-muted-foreground' : availabilityStatus ? 'bg-fresco' : 'bg-destructive')} />
