              ...
              {tables.map((table) => (
                ...
                >
                  <TableCell className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    ...
                    >
                      <span className="inline-flex items-center justify-center min-w-8 h-8 px-1 rounded-lg bg-slate-100 dark:bg-card text-slate-700 dark:text-foreground font-semibold text-xs max-w-[120px] truncate">
                        {table.name}
                      </span>
