  ...
  return (
    <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">Máximo 2 decimales (ej: 15.50)</p>
      </div>

      <div className="space-y-2">
        <Label className="text-sm font-medium">Categoría</Label>
        {isLoadingCategories ? (
          <div className="flex items-center gap-2 h-10 px-3 text-sm text-muted-foreground border border-border rounded-md">
          ...
          <Button
            ...
            className={cn('w-full justify-start text-muted-foreground', errors.categoryId && 'border-destructive')}
