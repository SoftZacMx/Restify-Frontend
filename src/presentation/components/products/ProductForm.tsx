...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  return (
    <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-6">
      <div className="rounded-xl border border-border bg-card shadow-lg p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">{name.length}/200 caracteres</p>
          </div>

          <div className="space-y-2">
            <Label htmlFor="status" className="text-sm font-medium">Estado</Label>
            <div className="flex h-[3.75rem] items-center justify-between gap-3 rounded-lg border border-border px-4">
      ...
      {!isEditMode && (
        <div className="rounded-xl border border-border bg-card shadow-lg p-6 space-y-4">
          ...
          {trackStock && (
            <div className="space-y-3 pt-2 border-t border-border">
              <div>
                <Label htmlFor="unitOfMeasure" className="text-xs uppercase tracking-wider text-muted-foreground font-semibold">
              ...
              <div>
                <Label htmlFor="minStockAlert" className="text-xs uppercase tracking-wider text-muted-foreground font-semibold">
