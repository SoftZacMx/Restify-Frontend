      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-center justify-between gap-4 py-2">
          <div className="min-w-0">
            <Label htmlFor="trackStock" className="text-sm font-medium text-foreground cursor-pointer">
              Trackear stock
            </Label>
        ...
        {trackStock && (
          <div className="space-y-4 pt-2 border-t border-border">
            ...
            <div>
              <Label htmlFor="minStockAlert" className="text-sm font-medium text-foreground">
