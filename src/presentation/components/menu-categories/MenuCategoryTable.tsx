...
/**
 * Componente MenuCategoryTable
 * Responsabilidad única: Renderizar tabla de categorías
 * Cumple SRP: Solo maneja la presentación de datos en tabla
 */
export const MenuCategoryTable: React.FC<MenuCategoryTableProps> = ({
  categories,
  isLoading = false,
  onCategoryAction,
}) => {
                  ...
                  <TableCell className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="w-40">
                        <DropdownMenuItem
                          onSelect={() => onCategoryAction?.(category.id, 'edit')}
                        ...
                        <DropdownMenuItem
                          onSelect={() => onCategoryAction?.(category.id, 'delete')}
                        ...
                        <DropdownMenuItem
                          onSelect={() => onCategoryAction?.(category.id, 'toggle-status')}
                          className="cursor-pointer"
                        >
                          <span>
