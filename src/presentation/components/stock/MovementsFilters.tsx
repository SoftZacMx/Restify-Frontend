...
const FILTER_TYPE_OPTIONS: FilterTypeOption[] = [
  {
    ...
    hoverClassName: 'hover:bg-muted dark:hover:bg-card/50 focus:bg-muted dark:focus:bg-card/50',
  },
...
export const MovementsFilters: React.FC<MovementsFiltersProps> = ({ filters, onFiltersChange }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-3 px-4 py-3 border-b border-border">
      <div className="flex flex-col">
        <Label htmlFor="movFrom" className="text-xs font-medium text-muted-foreground mb-1">
          Desde
        </Label>
        <Input
          id="movFrom"
      ...
      <div className="flex flex-col">
        <Label htmlFor="movTo" className="text-xs font-medium text-muted-foreground mb-1">
          Hasta
        </Label>
        <Input
          id="movTo"
      ...
      <div className="flex flex-col flex-grow">
        <Label htmlFor="movType" className="text-xs font-medium text-muted-foreground mb-1">
          Tipo de movimiento
        </Label>
        <Select
          value={filters.type}
