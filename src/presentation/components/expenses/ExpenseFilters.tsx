...
export const ExpenseFilters: React.FC<ExpenseFiltersProps> = ({
  ...
  return (
    <div className="space-y-4 px-4 py-3 border-b border-border overflow-x-visible min-w-0">
        ...
        <button
          ...
          className={`relative flex h-12 shrink-0 items-center gap-2 rounded-lg border px-3 text-sm font-medium transition-colors ${
            showAdvanced
              ...
              : 'border-border bg-muted text-foreground hover:bg-secondary dark:border-border dark:bg-card dark:text-foreground dark:hover:bg-card'
          }`}
        >
      ...
      <div className="md:hidden">
        <Select value={getCurrentTypeValue()} onValueChange={handleTypeChange}>
          <SelectTrigger className="h-9 w-full rounded-lg bg-muted border-border text-foreground text-sm font-medium">
            {(() => {
      ...
      <div className="hidden md:block border-b border-border -mx-4 px-4">
      ...
      {showAdvanced && (
        <div
          ...
          className="space-y-3 rounded-lg border border-border bg-muted/50 p-3 dark:border-border dark:bg-card/30"
        >
          {/* Método de pago */}
          <Select value={getCurrentPaymentMethodValue()} onValueChange={handlePaymentMethodChange}>
            <SelectTrigger className="h-9 rounded-lg bg-card border-border hover:bg-muted dark:hover:bg-card text-foreground text-sm font-medium w-full md:w-auto gap-1.5 px-3">
          ...
          <div className="flex flex-col md:flex-row items-center gap-2">
            <div className="flex items-center gap-2 w-full md:w-auto">
              ...
              <Input
                ...
                className="h-9 flex-1 md:w-[140px] rounded-lg bg-card border-border text-sm px-2"
              />
            </div>
            <div className="flex items-center gap-2 w-full md:w-auto">
              <Calendar className="h-3.5 w-3.5 text-muted-foreground shrink-0 md:hidden" />
