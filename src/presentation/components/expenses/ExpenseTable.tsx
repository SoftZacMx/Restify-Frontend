        ...
        {expenses.map((expense) => (
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger className="p-1.5 rounded-full text-muted-foreground hover:bg-muted dark:hover:bg-card transition-colors">
            ...
            <TableBody>
              {expenses.map((expense) => (
                ...
                >
                  ...
                  <TableCell className="px-6 py-4 text-sm font-medium text-foreground max-w-[200px]">
