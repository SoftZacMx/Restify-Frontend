...
> = {
  emerald: {
    ...
    cardHoverShadow: 'hover:shadow-xl hover:shadow-fresco/10',
    cornerGlow:
  ...
  amber: {
    ...
    cardShadow: 'shadow-lg',
    cardHoverShadow: 'hover:shadow-xl hover:shadow-apoyo/10',
    cornerGlow:
  ...
  blue: {
    ...
    cornerGlow:
      'before:absolute before:top-0 before:right-0 before:w-28 before:h-28 before:bg-primary/15 before:rounded-full before:translate-x-1/3 before:-translate-y-1/3 before:blur-2xl',
      ...
      <CardContent className="relative p-6">
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1 min-w-0">
            ...
            <h3 className="text-h1 md:text-display text-foreground tabular-nums tracking-tight drop-shadow-sm">
              {value}
            </h3>
          </div>
          {Icon && (
